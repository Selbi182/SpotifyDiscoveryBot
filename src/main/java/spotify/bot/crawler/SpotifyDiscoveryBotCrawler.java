...
public class SpotifyDiscoveryBotCrawler {
	 ...
	 * <li>Filter out all albums not released in the lookbackDays range (default: 30 days)</li>
	 ...
	 * </ol>
	 * 
	 * Finally, store the album IDs to the DB to prevent them from getting added a second time<br/>
	...
	/**
	 * Indicate whether or not the crawler is currently in progress
	 * 
	 * @return
	 */
