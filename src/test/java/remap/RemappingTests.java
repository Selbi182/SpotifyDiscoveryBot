...
public class RemappingTests {
	...
	public void epNegative() {
		...
		// assertFalse(willRemap(epRemapper, "3iGAuNUEmvxqRhvfWuFvEv")); // VOLA - These Black Claws [impossible to fix without breaking other stuff... EPs on Spotify can suck my dick]
	}
